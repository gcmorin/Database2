...
1. An admin can add a publisher by signing into their account.

2. A publisher can add an author by signing into their account.

3. Books have an additional series option, when you search up a book you can search up by series, that will show all the books in the series such as Lord of the Rings.