...
insert into author values (11, "Sam Winchester");
...
insert into book values ("978-1-14-123456-1", 1, 11, "hardcover", "The Bible: Part 3", 15.99, "Religous", "Cristianity");
insert into book values ("978-1-09-654321-1", 2, 12, "ebook", "The walking man", 5.99, "Horror", '');
insert into book values ("978-7-15-583928-4", 3, 11, "paperback", "Honeymoon mistake", 10.99, "Comedy", '');
insert into book values ("978-9-01-126556-1", 1, 12, "paperback", "Ant Boy and Spider Girl", 10.99, "Kids", "Ant Boy Adventures");
insert into book values ("970-1-64-876540-1", 2, 11, "audio", "Becoming a better person", 1.99, "Health", '');
...
insert into reviews values ("970-1-64-876540-1", 6, "After listening I became a worse person", 2);
...
insert into orders values ('', 8, 4, 10.98, "Liam Krike", "75 Venus St.", '2020-6-2',"liam@gmail.com");
